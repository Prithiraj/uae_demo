---
unique_code: "L3QQ"
lead_id: "DXB-NOWEB-0086"
google_place_id: "ChIJA0-36FpdXz4RXVjVADrsUBA"
research_date: "2026-09-04"
status: "Permanently closed"
---

# Chillama Beauty Salon

## Executive summary

Google marks the exact Place ID permanently closed. EmaratFinder still lists it, so directory data is stale. Exclude from active outreach.

## Identity

- **Unique code:** `L3QQ`
- **Lead ID:** `DXB-NOWEB-0086`
- **CSV name:** Chillama Beauty Salon
- **Current Google Maps name:** Chillama Beauty Salon
- **Google Place ID:** `ChIJA0-36FpdXz4RXVjVADrsUBA`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJA0-36FpdXz4RXVjVADrsUBA
...
- **Rating:** 3.9
- **Review count:** 7
- **Address:** 7878+V23 - Al Maktoum Rd - Al Muraqqabat - Deira - Dubai - United Arab Emirates
- **Phone:** +971 54 231 8289
...
- CSV area/address was `Al Maktoum Street`; current Maps gives `7878+V23 - Al Maktoum Rd - Al Muraqqabat - Deira - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJA0-36FpdXz4RXVjVADrsUBA) — identity anchor; Place ID `ChIJA0-36FpdXz4RXVjVADrsUBA`.
- [EmaratFinder](https://emaratfinder.net/categories/en/beauty-salons/dubai?p=3) — Still lists Chillama Beauty Salon on Al Maktoum Street without a website. Google Maps now marks the exact Place ID permanently closed.
- [Original lead source](https://emaratfinder.net/categories/en/beauty-salons/Dubai) — source used when the business was first collected into the CSV.
...
- **Business:** Chillama Beauty Salon
- **Unique code:** `L3QQ`
...
- **Phone:** +971 54 231 8289
- **Hours:** Not applicable
- **Google social proof snapshot:** 3.9 from 7 Google review(s) as captured on the research date.
...
- **Strongest research finding:** Google marks the exact Place ID permanently closed. EmaratFinder still lists it, so directory data is stale. Exclude from active outreach.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Chillama Beauty Salon — beauty salon in Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
**Reputation strategy:** Use the captured 3.9 / 7-review snapshot cautiously, with date/source attribution if displayed.
...
Use the research finding as the visual-story anchor: **Google marks the exact Place ID permanently closed. EmaratFinder still lists it, so directory data is stale. Exclude from active outreach.**
...
- **Proposed title pattern:** `Chillama Beauty Salon | Beauty salon in Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Chillama Beauty Salon as the verified beauty salon in Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `L3QQ` / **Chillama Beauty Salon**. **Do not implement until the plan and current business facts are approved.**
