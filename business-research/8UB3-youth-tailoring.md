---
unique_code: "8UB3"
lead_id: "DXB-NOWEB-0047"
google_place_id: "ChIJQRBpLklDXz4RxyrBTLJfd8c"
...
Google and directory agree on Deira/Al Matrooshi area, landline and split-shift schedule. No independent domain surfaced.

## Identity

- **Unique code:** `8UB3`
- **Lead ID:** `DXB-NOWEB-0047`
- **CSV name:** Youth Tailoring
- **Current Google Maps name:** Youth Tailoring
- **Google Place ID:** `ChIJQRBpLklDXz4RxyrBTLJfd8c`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJQRBpLklDXz4RxyrBTLJfd8c
...
- **Rating:** 5.0
- **Review count:** 6
- **Address:** 29 Deira St - Naif - Deira - Dubai - United Arab Emirates
- **Phone:** +971 4 224 2442
- **Hours:** Sat-Thu 09:00-13:30 & 16:00-22:30; Fri 16:00-22:30
...
- CSV phone was `04 224 2442`; current Maps snapshot returned `+971 4 224 2442`.
- CSV area/address was `Shop 26, Al Matrooshi Centre, Deira Street`; current Maps gives `29 Deira St - Naif - Deira - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJQRBpLklDXz4RxyrBTLJfd8c) — identity anchor; Place ID `ChIJQRBpLklDXz4RxyrBTLJfd8c`.
- [EmaratFinder](https://emaratfinder.net/categories/en/tailors/dubai?p=2) — Confirms Al Matrooshi Centre/Deira, landline and split-shift hours.
...
- **Phone:** +971 4 224 2442
- **Hours:** Sat-Thu 09:00-13:30 & 16:00-22:30; Fri 16:00-22:30
- **Google social proof snapshot:** 5.0 from 6 Google review(s) as captured on the research date.
...
- **Strongest research finding:** Google and directory agree on Deira/Al Matrooshi area, landline and split-shift schedule. No independent domain surfaced.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Youth Tailoring — clothing store in Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
**Reputation strategy:** Use the captured 5.0 / 6-review snapshot cautiously, with date/source attribution if displayed.
...
Use the research finding as the visual-story anchor: **Google and directory agree on Deira/Al Matrooshi area, landline and split-shift schedule. No independent domain surfaced.**
...
- **Proposed title pattern:** `Youth Tailoring | Clothing store in Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Youth Tailoring as the verified clothing store in Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `8UB3` / **Youth Tailoring**. **Do not implement until the plan and current business facts are approved.**
