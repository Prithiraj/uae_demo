---
unique_code: "DQED"
lead_id: "DXB-NOWEB-0008"
google_place_id: "ChIJ_5hG1_JcXz4RJPaOxsuuko4"
research_date: "2026-09-04"
status: "Active/unclear hours"
---

# Noor Al Qamar Tailoring & Embroidery

## Executive summary

Maps provides limited metadata beyond category/address/phone. Directory evidence corroborates the landline and Deira location; no website field is shown.

## Identity

- **Unique code:** `DQED`
- **Lead ID:** `DXB-NOWEB-0008`
- **CSV name:** Noor Al Qamar Tailoring & Embroidery
- **Current Google Maps name:** Noor Al Qamar Tailoring & Embroidery
- **Google Place ID:** `ChIJ_5hG1_JcXz4RJPaOxsuuko4`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJ_5hG1_JcXz4RJPaOxsuuko4
- **Category in CSV:** Tailor
- **Current Maps category:** Tailor
- **Area:** Deira

## Current Google Maps snapshot

- **Operational status:** Active/unclear hours
- **Rating:** Not returned
- **Review count:** Not returned
- **Address:** 79H2+72C - Hor Al Anz East - Deira - Dubai - United Arab Emirates
- **Phone:** +971 4 262 3655
- **Hours:** Not returned
...
- CSV area/address was `Deira, Dubai`; current Maps gives `79H2+72C - Hor Al Anz East - Deira - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJ_5hG1_JcXz4RJPaOxsuuko4) — identity anchor; Place ID `ChIJ_5hG1_JcXz4RJPaOxsuuko4`.
- [EmaratFinder](https://emaratfinder.net/categories/en/tailors/Dubai/deira?p=2) — Confirms Deira/AB Plaza vicinity and +971 4 262 3655; listing has phone/map but no website field.
- [Original lead source](https://www.google.com/maps/search/?api=1&query=Noor+Al+Qamar+Tailoring+%26+Embroidery%2C+Dubai%2C+United+Arab+Emirates) — source used when the business was first collected into the CSV.
...
- **Business:** Noor Al Qamar Tailoring & Embroidery
- **Unique code:** `DQED`
- **Verified Maps category:** Tailor
- **Area:** Deira
- **Operational status:** Active/unclear hours
- **Address:** 79H2+72C - Hor Al Anz East - Deira - Dubai - United Arab Emirates
- **Phone:** +971 4 262 3655
...
- **Strongest research finding:** Maps provides limited metadata beyond category/address/phone. Directory evidence corroborates the landline and Deira location; no website field is shown.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Noor Al Qamar Tailoring & Embroidery — tailor in Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
Use the research finding as the visual-story anchor: **Maps provides limited metadata beyond category/address/phone. Directory evidence corroborates the landline and Deira location; no website field is shown.**
...
- **Proposed title pattern:** `Noor Al Qamar Tailoring & Embroidery | Tailor in Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Noor Al Qamar Tailoring & Embroidery as the verified tailor in Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `DQED` / **Noor Al Qamar Tailoring & Embroidery**. **Do not implement until the plan and current business facts are approved.**
