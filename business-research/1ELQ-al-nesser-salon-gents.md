---
unique_code: "1ELQ"
lead_id: "DXB-NOWEB-0007"
google_place_id: "ChIJKyO3QwdrXz4RJCFIOY9D_8M"
research_date: "2026-09-04"
status: "Active"
---

# AL NESSER SALON (GENTS)

## Executive summary

Fresha exposes a service footprint broader than a traditional barber (children haircuts, straightening, keratin and women haircuts). The unusual Monday 24-hour Maps entry should be rechecked before using operationally.

## Identity

- **Unique code:** `1ELQ`
- **Lead ID:** `DXB-NOWEB-0007`
- **CSV name:** AL NESSER SALON (GENTS)
- **Current Google Maps name:** AL NESSER SALON (GENTS)
- **Google Place ID:** `ChIJKyO3QwdrXz4RJCFIOY9D_8M`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJKyO3QwdrXz4RJCFIOY9D_8M
- **Category in CSV:** Barber / gents salon
- **Current Maps category:** Hair salon; Beauty salon
- **Area:** Umm Suqeim 3
...
- CSV area/address was `Umm Suqeim 3, Dubai`; current Maps gives `52 30A St - Umm Suqeim Third - Umm Suqeim 3 - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJKyO3QwdrXz4RJCFIOY9D_8M) — identity anchor; Place ID `ChIJKyO3QwdrXz4RJCFIOY9D_8M`.
- [Fresha](https://www.fresha.com/lp/en/tt/men%27s-haircuts/in/ae-dubai/umm-suqeim-2) — Lists services including men/children haircuts, straightening and keratin treatments at the same Umm Suqeim 3 address and phone.
- [Original lead source](https://www.google.com/maps/search/?api=1&query=AL+NESSER+SALON+%28GENTS%29%2C+Dubai%2C+United+Arab+Emirates) — source used when the business was first collected into the CSV.
...
- **Business:** AL NESSER SALON (GENTS)
- **Unique code:** `1ELQ`
- **Verified Maps category:** Hair salon; Beauty salon
- **Area:** Umm Suqeim 3
- **Operational status:** Active
- **Address:** 52 30A St - Umm Suqeim Third - Umm Suqeim 3 - Dubai - United Arab Emirates
- **Phone:** +971 55 306 1155
...
**Approval checkpoint:** this file now contains the complete design plan for `1ELQ` / **AL NESSER SALON (GENTS)**. **Do not implement until the plan and current business facts are approved.**
