---
unique_code: "AF86"
lead_id: "DXB-NOWEB-0006"
google_place_id: "ChIJ_Scpht1dXz4RVoyg5IRTkvw"
research_date: "2026-09-04"
status: "Active"
---

# Alsharq gents saloon

## Executive summary

A high-review-count barber listing (roughly 700 Google reviews), making this one of the most established consumer-facing profiles in the set. Waze corroborates location, hours and phone. No independent website surfaced.

## Identity

- **Unique code:** `AF86`
- **Lead ID:** `DXB-NOWEB-0006`
- **CSV name:** Alsharq gents saloon
- **Current Google Maps name:** Alsharq gents saloon
- **Google Place ID:** `ChIJ_Scpht1dXz4RVoyg5IRTkvw`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJ_Scpht1dXz4RVoyg5IRTkvw
- **Category in CSV:** Barber / gents salon
- **Current Maps category:** Barber shop
...
- **Rating:** 4.9
- **Review count:** 698
- **Address:** 1B St, Port Saeed - Deira - Dubai - United Arab Emirates
- **Phone:** +971 54 722 9787
...
- CSV area/address was `Port Saeed, Deira, Dubai`; current Maps gives `1B St, Port Saeed - Deira - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJ_Scpht1dXz4RVoyg5IRTkvw) — identity anchor; Place ID `ChIJ_Scpht1dXz4RVoyg5IRTkvw`.
- [Waze](https://www.waze.com/live-map/directions/ae/dubai/dubai/alsharq-gents-saloon?to=place.ChIJ_Scpht1dXz4RVoyg5IRTkvw) — Confirms Place ID, Port Saeed address, phone and 09:00-01:00 daily schedule.
- [Original lead source](https://www.google.com/maps/search/?api=1&query=Alsharq+gents+saloon%2C+Dubai%2C+United+Arab+Emirates) — source used when the business was first collected into the CSV.
...
- **Business:** Alsharq gents saloon
- **Unique code:** `AF86`
- **Verified Maps category:** Barber shop
- **Area:** Port Saeed / Deira
- **Operational status:** Active
- **Address:** 1B St, Port Saeed - Deira - Dubai - United Arab Emirates
- **Phone:** +971 54 722 9787
- **Hours:** Daily 09:00-01:00
- **Google social proof snapshot:** 4.9 from 698 Google review(s) as captured on the research date.
...
- **Strongest research finding:** A high-review-count barber listing (roughly 700 Google reviews), making this one of the most established consumer-facing profiles in the set. Waze corroborates location, hours and phone. No independent website surfaced.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Alsharq gents saloon — barber shop in Port Saeed / Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
- Exact Google Maps identity in **Port Saeed / Deira** with a stable Place ID.
- Substantial Maps social-proof footprint: 4.9 rating across 698 reviews on the research date.

**Reputation strategy:** The captured Maps footprint (4.9 / 698 reviews) is strong enough to support a visible social-proof module, subject to current platform attribution/policy requirements.
...
Use the research finding as the visual-story anchor: **A high-review-count barber listing (roughly 700 Google reviews), making this one of the most established consumer-facing profiles in the set. Waze corroborates location, hours and phone. No independent website surfaced.**
...
- **Proposed title pattern:** `Alsharq gents saloon | Barber shop in Port Saeed / Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Alsharq gents saloon as the verified barber shop in Port Saeed / Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `AF86` / **Alsharq gents saloon**. **Do not implement until the plan and current business facts are approved.**
