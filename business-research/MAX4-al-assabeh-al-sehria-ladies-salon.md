---
unique_code: "MAX4"
lead_id: "DXB-NOWEB-0077"
google_place_id: "ChIJKY9fpY1cXz4Ryk_naESApYA"
research_date: "2026-09-04"
status: "Active"
---

# Al Assabeh Al Sehria Ladies Salon

## Executive summary

Maps and independent directory agree on phone and Hor Al Anz/Deira. Web presence is minimal; no independent domain surfaced.

## Identity

- **Unique code:** `MAX4`
- **Lead ID:** `DXB-NOWEB-0077`
- **CSV name:** Al Assabeh Al Sehria Ladies Salon
- **Current Google Maps name:** Al Assabeh Al Sehria Ladies Salon
- **Google Place ID:** `ChIJKY9fpY1cXz4Ryk_naESApYA`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJKY9fpY1cXz4Ryk_naESApYA
...
- **Rating:** 4.3
- **Review count:** 3
- **Address:** 78JX+PRH - Hor Al Anz East - Deira - Dubai - United Arab Emirates
- **Phone:** +971 4 268 4523
- **Hours:** Not returned
...
- CSV phone was `04 268 4523`; current Maps snapshot returned `+971 4 268 4523`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJKY9fpY1cXz4Ryk_naESApYA) — identity anchor; Place ID `ChIJKY9fpY1cXz4Ryk_naESApYA`.
- [UAE Arab Local](https://uae.arablocal.com/business/view/al-assabeh-al-sehria-ladies-salon) — Confirms Hor Al Anz/Dubai and +971 4 268 4523.
- [EmaratFinder](https://emaratfinder.net/categories/en/beauty-salons/Dubai/deira?p=1) — Lists the same salon and landline with no website field.
...
- **Business:** Al Assabeh Al Sehria Ladies Salon
- **Unique code:** `MAX4`
...
- **Phone:** +971 4 268 4523
- **Hours:** Not returned
- **Google social proof snapshot:** 4.3 from 3 Google review(s) as captured on the research date.
...
- **Strongest research finding:** Maps and independent directory agree on phone and Hor Al Anz/Deira. Web presence is minimal; no independent domain surfaced.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Al Assabeh Al Sehria Ladies Salon — beauty salon in Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
**Reputation strategy:** Use the captured 4.3 / 3-review snapshot cautiously, with date/source attribution if displayed.
...
Use the research finding as the visual-story anchor: **Maps and independent directory agree on phone and Hor Al Anz/Deira. Web presence is minimal; no independent domain surfaced.**
...
- **Proposed title pattern:** `Al Assabeh Al Sehria Ladies Salon | Beauty salon in Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Al Assabeh Al Sehria Ladies Salon as the verified beauty salon in Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `MAX4` / **Al Assabeh Al Sehria Ladies Salon**. **Do not implement until the plan and current business facts are approved.**
