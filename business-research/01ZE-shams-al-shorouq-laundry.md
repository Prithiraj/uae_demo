---
unique_code: "01ZE"
lead_id: "DXB-NOWEB-0025"
google_place_id: "ChIJ6yg8xFeL9T4RgTrhMvFfNVI"
research_date: "2026-09-04"
status: "Active"
---

# Shams Al Shorouq Laundry

## Executive summary

Google, 2GIS and Yango converge on Al Khawaneej. Third-party phone masking/omission means the Google phone should be preferred.

## Identity

- **Unique code:** `01ZE`
- **Lead ID:** `DXB-NOWEB-0025`
- **CSV name:** Shams Al Shorouq Laundry
- **Current Google Maps name:** SHAMS AL SHOROUQ LAUNDRY
- **Google Place ID:** `ChIJ6yg8xFeL9T4RgTrhMvFfNVI`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJ6yg8xFeL9T4RgTrhMvFfNVI
...
- CSV phone was `050 541 8386`; current Maps snapshot returned `+971 50 541 8386`.
- CSV area/address was `Al Amardi Street`; current Maps gives `6GF3+9V5 - Al Khawaneej - Al Khwaneej Second - Dubai - United Arab Emirates`.
- Current Maps display name is `SHAMS AL SHOROUQ LAUNDRY`; CSV name is `Shams Al Shorouq Laundry`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJ6yg8xFeL9T4RgTrhMvFfNVI) — identity anchor; Place ID `ChIJ6yg8xFeL9T4RgTrhMvFfNVI`.
- [2GIS](https://2gis.ae/dubai/firm/70000001053838247) — Places the laundry at 129 Al Khawaneej Street, ground floor, and shows WhatsApp.
- [Yango Maps](https://maps.yango.com/en-ae/org/83580636715/) — Confirms 129 Al Khawaneej Street and midnight closing; phone is not shown there.
...
- **Business:** SHAMS AL SHOROUQ LAUNDRY
- **Unique code:** `01ZE`
...
**Approval checkpoint:** this file now contains the complete design plan for `01ZE` / **SHAMS AL SHOROUQ LAUNDRY**. **Do not implement until the plan and current business facts are approved.**
