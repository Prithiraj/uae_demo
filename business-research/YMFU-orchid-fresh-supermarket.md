---
unique_code: "YMFU"
lead_id: "DXB-NOWEB-0101"
google_place_id: "ChIJd6kXkANdXz4Rwk1XkG3aGlM"
research_date: "2026-09-04"
status: "Active"
---

# Orchid Fresh Supermarket

## Executive summary

Google/Waze show 24-hour operation and same phone. Local Emirates adds a more specific Al Jawahara Building/Al Ittihad Road location and Facebook presence. No independent domain surfaced.

## Identity

- **Unique code:** `YMFU`
- **Lead ID:** `DXB-NOWEB-0101`
- **CSV name:** Orchid Fresh Supermarket
- **Current Google Maps name:** Orchid Fresh Supermarket
- **Google Place ID:** `ChIJd6kXkANdXz4Rwk1XkG3aGlM`
- **Exact Google Maps URL:** https://www.google.com/maps/place/?q=place_id:ChIJd6kXkANdXz4Rwk1XkG3aGlM
- **Category in CSV:** Grocery / supermarket
- **Current Maps category:** Supermarket
- **Area:** Deira
...
- CSV phone was `04 268 3421`; current Maps snapshot returned `+971 4 268 3421`.
- CSV area/address was `Ground Floor, Al Jawahara Building, Al Ittihad Road`; current Maps gives `Hor Al Anz East - Deira - Dubai - United Arab Emirates`.
...
- [Google Maps exact listing](https://www.google.com/maps/place/?q=place_id:ChIJd6kXkANdXz4Rwk1XkG3aGlM) — identity anchor; Place ID `ChIJd6kXkANdXz4Rwk1XkG3aGlM`.
- [Waze](https://www.waze.com/live-map/directions/ae/dubai/dubai/orchid-fresh-supermarket?to=place.ChIJd6kXkANdXz4Rwk1XkG3aGlM) — Confirms the same Place ID, phone and 24-hour schedule.
- [Local Emirates](https://localemirates.com/profile/en/753979-orchid-fresh-supermarket) — Places the business on the ground floor of Al Jawahara Building/Al Ittihad Road and notes a Facebook presence.
...
- **Business:** Orchid Fresh Supermarket
- **Unique code:** `YMFU`
- **Verified Maps category:** Supermarket
- **Area:** Deira
- **Operational status:** Active
- **Address:** Hor Al Anz East - Deira - Dubai - United Arab Emirates
- **Phone:** +971 4 268 3421
- **Hours:** Open 24 hours daily
- **Google social proof snapshot:** 4.2 from 45 Google review(s) as captured on the research date.
...
- **Strongest research finding:** Google/Waze show 24-hour operation and same phone. Local Emirates adds a more specific Al Jawahara Building/Al Ittihad Road location and Facebook presence. No independent domain surfaced.
- **Evidence-backed value-proposition direction:** Proposed evidence-supported positioning: **Orchid Fresh Supermarket — supermarket in Deira, Dubai**, anchored by verified contact/location details. Final marketing wording requires owner approval.
...
**Reputation strategy:** Use the captured 4.2 / 45-review snapshot cautiously, with date/source attribution if displayed.
...
Use the research finding as the visual-story anchor: **Google/Waze show 24-hour operation and same phone. Local Emirates adds a more specific Al Jawahara Building/Al Ittihad Road location and Facebook presence. No independent domain surfaced.**
...
- **Proposed title pattern:** `Orchid Fresh Supermarket | Supermarket in Deira, Dubai` (shorten if needed to avoid truncation).
- **Meta description direction:** describe Orchid Fresh Supermarket as the verified supermarket in Deira; include one or two verified service/location facts and end with the primary verified action. Avoid superlatives.
...
**Approval checkpoint:** this file now contains the complete design plan for `YMFU` / **Orchid Fresh Supermarket**. **Do not implement until the plan and current business facts are approved.**
